...
public class Pixel {
	...
	// Define vectors containing the posizion of Pixels
	 ...
	 * @param leftversor is the versor moving left to the PMT
	 */
	public Pixel (Vector3d corner, Vector3d downversor, Vector3d leftversor)
	{
		this();
		...
		P3.add(downversor.times((this.PXDY[1])/2)); //Define the position of the first pixel
		P3.add(leftversor.times((this.PXDX[1])/2)); //Define the position of the first pixel 
		...
		{   	
			...
			{       			
				...
				P3.add(leftversor.times((this.PXDX[kk-1]+this.PXDX[kk])/2));
				// ********
